 ...
 */
public class FXML_Dekada_MasterCardController extends FXML_Home_Controller implements Initializable, IErrorInterface {

    private ObservableList<MasterCardItem> observableList;
    private TypingUtility_MasterCard typingUtility;
    ...
    @FXML
    private TableView<MasterCardItem> tableView;
    @FXML
        ...
        itemPaste.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (clipboard.hasString()) {
                    ...
                    try {
                        initFileLoader(clipboard.getString(), paymentCode, mb);
                    } catch (IOException ex) {
                        Logger.getLogger(FXML_Dekada_MasterCardController.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void startTyping(ActionEvent event) throws AWTException {
        ...
        typingUtility = new TypingUtility_MasterCard(Integer.parseInt(delayTextField.getText()));
    ...
    private void initFileLoader(String args, String paymentCode, String mb) throws IOException {

        ReferenceStringLoader_MasterCard loader = new ReferenceStringLoader_MasterCard();

        //specialType is user choice for conviniance of different table formats
        observableList.addAll(loader.getList(args, paymentCode, mb));

        for (MasterCardItem masterCardItem : observableList) {
            System.out.println(masterCardItem.getReference());
        }
